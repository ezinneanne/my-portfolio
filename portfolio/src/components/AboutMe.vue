  ...
  <section id="about" class="bg-white py-20 md:py-28">
    <div class="container mx-auto px-6 grid md:grid-cols-5 gap-12 items-center">
      <div class="md:col-span-2">
        <img src="../assets/EzinneAnneEmilia.png" alt="Portrait of Ezinne Anne Emilia" class="rounded-lg shadow-2xl w-full">
      </div>
      <div class="md:col-span-3">
        <h2 class="text-3xl font-bold text-primary mb-4">About Me</h2>
        <p class="text-gray-600 mb-4 leading-relaxed">
          Hi, I’m <strong>Ezinne</strong> — a curious mind who loves turning complex systems into seamless, automated flows and clear, human-centered documentation.
        </p>
        <p class="text-gray-600 mb-4 leading-relaxed">
